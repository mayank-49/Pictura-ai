...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        <motion.button onClick={onClickHandler} className={`sm:text-lg cursor-pointer w-auto mt-8 px-12 py-2.5 flex items-center gap-4 rounded-full ${theme == 'light' ? "text-white bg-black" : "text-white bg-white/20 border border-white"}`}
        ...
        className={`mt-2 ${theme == 'light' ? "text-neutral-600" : "text-slate-400"} `}>Generated images from imagify</motion.p>
